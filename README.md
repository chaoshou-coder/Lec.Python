...
4. **每 7-10 天**:阶段复习日(Day 09/16/39)或 期末答辩(Day 58)
...
| 能力 | 终点标准 | 对应模块 |
|---|---|---|
| **机器学习** | 能基于 scikit-learn 完成端到端 ML 项目 | Module 1 (Day 17-23) |
| **LLM 微调** | 能基于 Hugging Face + LoRA 微调开源大模型 | Module 4 (Day 35-41) |
| **Web 爬虫** | 能写 HTTP/API/动态页面爬虫构建数据集 | Module 5 (Day 42-48) |
| **AI 应用开发** | 能开发 RAG/Agent/AI API 应用并部署 | Module 6 (Day 49-58) |
...
> 📖 Day 18-58(ML/DL/NLP/LLM/爬虫/AI 应用)暂未制作 Jupyter 版,使用 `course/lessonXX/` 的 slides + 习题自学。
