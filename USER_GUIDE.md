...
| 7 | [63 天课表总览](#7-60-天课表总览) | 6 个 Module 的 Day 列表 |
...
| 终点能力 | 具体标准 | 对应模块 |
|---|---|---|
| **机器学习** | 基于 scikit-learn 完成端到端 ML 项目(数据→预处理→建模→评估→部署) | Module 1 (Day 18-24) |
| **LLM 微调** | 基于 Hugging Face + LoRA 微调开源大模型→评测→推理部署 | Module 4 (Day 36-42) |
| **Web 爬虫** | HTTP/API/动态页面爬虫→数据清洗→存储→构建数据集 | Module 5 (Day 43-49) |
| **AI 应用开发** | FastAPI + RAG + Agent + Docker 部署,上线 AI 应用 | Module 6 (Day 50-59) |
...
| 模式 | 周期 | 每日投入 |
|---|---|---|
| 全日制集训 | **63 天**(约 12 周) | 6 小时/天(360 分钟) |
...
| Day 59 | 期末答辩(Demo 演示 5' + 问答 5' + 互评) | Demo + 答辩记录 |
...
> 📋 详细评分细则见 `course/lesson59/FINAL_PROJECT_RUBRIC.md`
