...
| 3 | 小写化输入字符串(Indoor Voice) | ⭐ | CS50P Week0 | 03 |
| 4 | 字符串替换表情符号(Making Faces) | ⭐⭐ | CS50P Week0 | 03 |
| 5 | Tip Calculator(餐费分账,四舍五入) | ⭐⭐ | CS50P Week0 | 03 |
| 6 | 九九乘法表,右对齐输出 | ⭐⭐ | 小甲鱼 P36 | 04 |
| 7 | 打印小星星斜三角/倒三角 | ⭐⭐ | 黑马 Day07 | 04 |
| 8 | 石头剪刀布人机对战 | ⭐⭐ | 小甲鱼 P58 | 04 |
| 9 | 猜数字(1–100,提示大小) | ⭐⭐⭐ | 黑马 Day05 | 05 |
| 10 | FizzBuzz(1–100 输出) | ⭐ | py4e Ch2 | 05 |
| 11 | 回文数/字符串判别 | ⭐⭐ | w3resource Basic | 05 |
| 12 | 计算两点距离 | ⭐⭐ | PCC Ch02 | 05 |
| 13 | 计算复利 n 年后总额 | ⭐⭐ | py4e Ch3 | 06 |
...
| **通讯录 v2** | 函数封装 + 文件持久化 | 黑马 Day08 | 12 |

---

### 2.3 文件 / 异常 / JSON / CSV(Day13–Day17)
...
## 4. 本课程(我们的 21 天)与市面对比

| 维度 | 黑马 28 天 | 达内 30 天 | 廖雪峰 14 天速成 | 莫烦 Python | 小甲鱼 98 课 | **我们的 21 天** |
|---|---|---|---|---|---|---|
| **总时长** | ~168h | ~180h | ~84h | ~60h | ~100h | ~126h |
| **每日强度** | 6h | 6h | 6h | 弹性 | 弹性 | 6h |
| **基础语法** | Day01–07 | Day01–07 | 1–2 周 | 简略 | 30 课 | Day01–07 |
| **函数 / 高阶** | Day08–09 | Day08–10 | 1 周 | 简略 | 10 课 | Day08–12(5 天) |
| **文件 / 异常 / JSON / CSV** | Day10–12 | Day10–14 | 1 周 | 无 | 5 课 | Day13–17(5 天) |
| **OOP 基础** | Day13 | Day15 | 2–3 天 | 无 | 15 课 | Day18–19(2 天) |
| **OOP 进阶** | Day14 | Day16 | 1–2 天 | 无 | 10 课 | Day20–21(2 天) |
| **OOP 总课时** | 2 天 | 2 天 | 3–5 天 | 0 | 25 课(≈5 天) | **4 天(含 1 天综合项目)** |
...
| **期末作品** | 飞机大战(Pygame) | 爬虫 + 数据分析 | 无 | ML Demo | 3 选 1 | **控制台图书管理系统 v2** |
| **适合人群** | 就业导向 | 就业导向 | 快速了解 | ML 兴趣 | 视频偏好 | **零基 + 考证 / 跨考 / 兴趣** |

### 我们的核心优势

1. **练习密度最高**:每节 in_class 当场练 + 每日 homework + 每周 mini-project,远超廖雪峰/莫烦的"读懂为主"模式
2. **OOP 系统性最强**:4 天递进(基础 → 继承多态 → 封装魔术方法 → 抽象设计) + 1 天综合项目,比黑马/达内的 2 天 OOP 深 2 倍
